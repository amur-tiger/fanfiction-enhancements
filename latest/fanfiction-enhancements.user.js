...
(function (jQueryProxy, ko) {
    ...
    ***************************************************************************** */
    ...
    class Api {
        ...
        putAlert(story) {
            return __awaiter(this, void 0, void 0, function* () {
                yield this.api.putAlert(story);
                yield this.cache.putAlert(story);
            });
        }
        /**
        ...
        hasAlert(story) {
            return __awaiter(this, void 0, void 0, function* () {
                const isFresh = yield this.cache.isAlertsFresh();
                if (!isFresh) {
                    const alerts = yield this.api.getStoryAlerts();
                    yield this.cache.putAlerts(alerts);
                }
        ...
        putFavorite(story) {
            return __awaiter(this, void 0, void 0, function* () {
                yield this.api.putFavorite(story);
                yield this.cache.putFavorite(story);
            });
        }
        /**
        ...
        isFavorite(story) {
            return __awaiter(this, void 0, void 0, function* () {
                const isFresh = yield this.cache.isFavoritesFresh();
                if (!isFresh) {
                    const favorites = yield this.api.getStoryFavorites();
                    yield this.cache.putFavorites(favorites);
                }
        ...
        getStoryInfo(id) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    const story = yield this.cache.getStory(id);
                    if (story.chapters.find(chapter => chapter.words === undefined)) {
                        yield this.api.applyChapterLengths(story);
                        yield this.cache.putStory(story);
                    }
                    attachHandlers(story);
                    return story;
                }
                catch (e) {
                    const story = yield this.api.getStoryInfo(id);
                    yield this.api.applyChapterLengths(story);
                    yield this.applyFollowStates(story);
                    attachHandlers(story);
                    return story;
                }
            });
        ...
        applyFollowStates(story) {
            return __awaiter(this, void 0, void 0, function* () {
                const hasAlert = yield this.hasAlert(story);
                const isFavorite = yield this.isFavorite(story);
    ...
    class ApiImmediate {
        ...
        putAlert(story) {
            return __awaiter(this, void 0, void 0, function* () {
                yield (story.follow() ? this.followStory(story) : this.unFollowStory(story));
            });
        }
        /**
         * Updates the FFN favorite state of a story according to the given story object.
        ...
        putFavorite(story) {
            return __awaiter(this, void 0, void 0, function* () {
                yield (story.favorite() ? this.favoriteStory(story) : this.unFavoriteStory(story));
            });
        }
        /**
         * Retrieves all story alerts that are set on FFN for the current user.
        ...
        getStoryInfo(id) {
            return __awaiter(this, void 0, void 0, function* () {
                const data = yield this.apiCall("GET", "/s/" + id);
                const story = parseProfile(data);
                yield this.applyChapterLengths(story);
                return story;
            });
        }
        applyChapterLengths(story) {
            return __awaiter(this, void 0, void 0, function* () {
                yield Promise.all(story.chapters
                    .filter(chapter => chapter.words === undefined)
                    .map((chapter) => __awaiter(this, void 0, void 0, function* () {
                    const body = yield this.apiCall("GET", "/s/" + story.id + "/" + chapter.id);
                    const template = document.createElement("template");
        ...
        getMultiPage(url) {
            return __awaiter(this, void 0, void 0, function* () {
                const body = yield this.apiCall("GET", url);
                const template = document.createElement("template");
                template.innerHTML = body;
        ...
        followStory(story) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                yield this.apiCall("POST", "/api/ajax_subs.php", {
                    storyid: story.id,
        ...
        unFollowStory(story) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                yield this.apiCall("POST", "/alert/story.php", {
                    action: "remove-multi",
                    "rids[]": story.id,
                });
            });
        ...
        unFavoriteStory(story) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                yield this.apiCall("POST", "/favorites/story.php", {
                    action: "remove-multi",
                    "rids[]": story.id,
                });
            });
    ...
    class Cache$1 {
        ...
        isAlertsFresh() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                return timestamp + Cache$1.FOLLOWS_LIFETIME > new Date().getTime();
            });
        }
        /**
        ...
        putStory(story) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    save(yield this.getStory(story.id));
                }
                catch (e) {
                    save(undefined);
                }
