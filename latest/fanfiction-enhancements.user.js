...
(function (ffnParser) {
  ...
  class Api {
      ...
      async getChapterWordCount(storyId, chapterId) {
          ...
          const template = document.createElement("template");
          template.innerHTML = body;
          return (_e = (_d = (_c = (_b = (_a = template.content.getElementById("storytext")) === null || _a === void 0 ? void 0 : _a.textContent) === null || _b === void 0 ? void 0 : _b.trim()) === null || _c === void 0 ? void 0 : _c.split(/\s+/)) === null || _d === void 0 ? void 0 : _d.length) !== null && _e !== void 0 ? _e : 0;
      }
      ...
      async post(url, data, expect) {
          ...
          if (err) {
              throw new Error((_a = err.textContent) !== null && _a !== void 0 ? _a : undefined);
          }
  ...
  class FollowsList {
      ...
      async enhance() {
          ...
          const table = (_a = document.getElementById("gui_table1i")) === null || _a === void 0 ? void 0 : _a.parentElement;
          if (!table) {
              return;
          }
          (_b = table.parentElement) === null || _b === void 0 ? void 0 : _b.insertBefore(container, table);
          ...
          (_c = table.parentElement) === null || _c === void 0 ? void 0 : _c.removeChild(table);
      }
  }

  var css_248z$3 = ".ffe-mb-separator:before {\n\tcontent: \" | \";\n}\n\n.ffe-mb-checked:before {\n\tbackground: green;\n\tborder-radius: 50%;\n\tbottom: 2px;\n\tcolor: #fff;\n\tcontent: \"✓\";\n\tfont-size: 9px;\n\theight: 12px;\n\tline-height: 12px;\n\tposition: absolute;\n\tright: -2px;\n\twidth: 12px;\n}\n\n.ffe-mb-icon {\n\tdisplay: inline-block;\n\tline-height: 2em;\n\tmargin-top: -.5em;\n\ttext-align: center;\n\twidth: 2em;\n}\n\n.ffe-mb-icon:hover {\n\tborder-bottom: 0;\n\tcolor: orange !important;\n}\n\n.ffe-mb-dropbox {\n\ttransform: translateY(3px);\n}\n\n.ffe-mb-dropbox:hover .st0 {\n\tfill: orange;\n}\n";
  ...
  class MenuBar {
      ...
      async enhance() {
          ...
          const parent = loginElement === null || loginElement === void 0 ? void 0 : loginElement.parentElement;
          const ref = loginElement === null || loginElement === void 0 ? void 0 : loginElement.nextElementSibling;
          if (!parent || !ref) {
              return;
          }
          ...
          toDropBox.href = "#";
          toDropBox.innerHTML =
              '<svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 42.4 39.5" ' +
  ...
  class DropBox {
      ...
      async synchronize() {
          ...
          await Promise.all(Object.keys(remoteData).map(async (key) => {
              ...
              const localTimestamp = +((_a = (await GM.getValue(`${key}+timestamp`))) !== null && _a !== void 0 ? _a : 0);
  ...
  function oAuth2LandingPage() {
      ...
      const token = (_a = /[?&#]access_token=([^&#]*)/i.exec(window.location.hash)) === null || _a === void 0 ? void 0 : _a[1];
      ...
      if (environment.currentPageType === 5 /* Chapter */) {
          ...
          if (currentStory) {
              ...
              if (environment.currentChapterId) {
                  ...
                  await wordCountValue.update((_d = (_c = (_b = (_a = document.getElementById("storytext")) === null || _a === void 0 ? void 0 : _a.textContent) === null || _b === void 0 ? void 0 : _b.trim()) === null || _c === void 0 ? void 0 : _c.split(/\s+/).length) !== null && _d !== void 0 ? _d : 0);
              }
              const storyProfileEnhancer = container.getStoryProfile();
              await storyProfileEnhancer.enhance();
              ...
              if (environment.currentChapterId) {
                  ...
                  const markRead = async () => {
                      ...
                      if (amount / (max - 550) >= 1) {
                          ...
                          // eslint-disable-next-line no-console
                          console.log("Setting '%s' chapter '%s' to read", currentStory.title, (_a = currentStory.chapters.find((c) => c.id === environment.currentChapterId)) === null || _a === void 0 ? void 0 : _a.title);
